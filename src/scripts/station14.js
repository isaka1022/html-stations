...
function buildFullName(data) {
    ...
    // let rObj = {
    //     id: obj.id, full_name: obj.first_name + ' ' + obj.family_name, first_name: obj.first_name, family_name: obj.family_name, affilication: obj.affilication, is_student: obj.is_student
    // };
    // console.log(rObj);
    // return rObj;
    return {
        id: data.id, full_name: data.family_name + ' ' + data.first_name, first_name: data.first_name, family_name: data.family_name, affilication: data.affilication, is_student: data.is_student
    };
}
